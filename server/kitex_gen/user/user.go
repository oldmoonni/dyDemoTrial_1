...
func (p *UserRegisterResponse) Field3DeepEqual(src *BaseResp) bool {
...
func (p *UserLoginRequest) SetName(val string) {
	p.Name = val
}
...
func (p *UserLoginResponse) Field3DeepEqual(src *BaseResp) bool {
...
func (p *UserInfoResponse) Field2DeepEqual(src *BaseResp) bool {
