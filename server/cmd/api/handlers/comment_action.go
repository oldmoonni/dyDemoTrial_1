...
func cp2c(pcomment *interact.Comment) (comment Comment) {
	comment = Comment{
		...
		User: User{
			...
			Avatar: pcomment.User.Avatar,
			BackgroundImage: pcomment.User.BackgroundImage,
			Signature: pcomment.User.Signature,
			TotalFavorited: pcomment.User.TotalFavorited,
			WorkCount: pcomment.User.WorkCount,
			FavoriteCount: pcomment.User.FavoriteCount,
		},
